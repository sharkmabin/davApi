package com.mabin.dav.framework.model.manager;
...
import com.mabin.dav.framework.model.module.entity.ModuleInfo;
import com.mabin.dav.framework.model.module.interfaces.IApplicationDelegate;
import com.mabin.dav.framework.model.module.utils.ModuleClassUtils;
        ...
        try {
            ...
            for(int i = 0; i < fileLength; ++i) {
                ...
                if(fileName.startsWith(MODULE_PREFIX)) {
                    ...
                    DLogger.d(TAG, "load Module: " + moduleInfo.getModuleName());
                }
            }
