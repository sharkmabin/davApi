package com.mabin.dav.framework.model.base;
...
import com.mabin.dav.framework.model.manager.ModuleManager;
...
public class BaseApplication extends Application {
    ...
    private class ActivityLifecycleCallbacksImpl implements ActivityLifecycleCallbacks {
        ...
        public void onActivityCreated(Activity activity, Bundle bundle) {
            DLogger.d(TAG, "onActivityCreated --> " + activity.getClass().getName());
            BaseApplication.this.mActivityList.add(0, activity);
        }

        @Override
        public void onActivityStarted(Activity activity) {
            DLogger.d(TAG, "onActivityStarted --> " + activity.getClass().getName());
            if(BaseApplication.this.mCurrentCount == 0 && !BaseApplication.this.isCurrent) {
                ...
                DLogger.d("BaseApplication", "The App go to foreground");
            }
        ...
        public void onActivityResumed(Activity activity) {
            DLogger.d(TAG, "onActivityResumed --> " + activity.getClass().getName());
        ...
        public void onActivityPaused(Activity activity) {
            DLogger.d(TAG, "onActivityPaused --> " + activity.getClass().getName());
        }

        @Override
        public void onActivityStopped(Activity activity) {
            DLogger.d(TAG, "onActivityStopped --> " + activity.getClass().getName());
            ...
            if(BaseApplication.this.mCurrentCount == 0 && BaseApplication.this.isCurrent) {
                ...
                DLogger.d(TAG, "The App go to background");
            }
        }

        @Override
        public void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
            DLogger.d(TAG, "onActivitySaveInstanceState --> " + activity.getClass().getName());
        }

        @Override
        public void onActivityDestroyed(Activity activity) {
            DLogger.d(TAG, "onActivityDestroyed --> " + activity.getClass().getName());
