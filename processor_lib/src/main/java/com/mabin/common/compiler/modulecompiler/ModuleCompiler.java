package com.mabin.common.compiler.modulecompiler;

import com.google.gson.Gson;
import com.google.gson.stream.JsonWriter;
import com.mabin.annotations.EFModuleAnnotation;
import com.mabin.common.compiler.info.ModuleProxyInfo;
...
public class ModuleCompiler extends AbstractProcessor {
    ...
    private void error(Element e, String msg, Object... args) {
        this.mMessager.printMessage(Diagnostic.Kind.ERROR, String.format(msg, args), e);
    }

    private void error(String msg, Object... args) {
        this.mMessager.printMessage(Diagnostic.Kind.ERROR, String.format(msg, args));
    }

    private void note(String msg, Object... args) {
        this.mMessager.printMessage(Diagnostic.Kind.NOTE, String.format(msg, args));
    }
}
